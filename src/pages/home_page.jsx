...
function HomePage() {
    ...
    return <div className="flex flex-col bg-zinc-800 h-full pt-10 pb-4 place-items-center">
        <span className="font-lobster text-white font-bold text-3xl">Subtitle Forge</span>
        <br />
        <br />
        ...
        <div className="w-[70%] h-[50%] bg-customGray flex justify-center items-center rounded-lg " onClick={async () => {
            ...
            if (selected != null) {
                const videoUrl = selected.toString()
                navigate("/project_creation", { videoPath: videoUrl });
            }
        }}>
